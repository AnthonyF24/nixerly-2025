  ...
  return (
    <MainLayout>
      ...
      <section className="relative bg-gradient-to-br from-blue-800 via-blue-700 to-purple-800 text-white overflow-hidden">
        ...
        <div className="absolute top-20 right-10 w-64 h-64 bg-purple-500 rounded-full opacity-20 blur-xl"></div>
        <div className="absolute bottom-10 left-10 w-72 h-72 bg-blue-400 rounded-full opacity-20 blur-xl"></div>
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fadeIn">
              <Badge className="px-4 py-1.5 bg-white/10 backdrop-blur-[2px] text-white border-white/20 hover:bg-white/20 transition-all">Welcome to Nixerly</Badge>
              ...
              <div className="flex flex-col sm:flex-row gap-5 pt-2">
                <Button size="lg" className="bg-white text-blue-700" asChild>
                  <Link href="/auth/signup?type=professional">
                    Sign Up as a Professional
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="border-white bg-blue-600/30 backdrop-blur-[2px] text-white hover:bg-blue-500/50 font-medium border-2 hover:shadow-lg transition-all duration-300" asChild>
            ...
            <div className="hidden md:block relative h-[450px] w-full transform transition-all duration-700 hover:scale-[1.02]">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-2xl backdrop-blur-[2px] rotate-2"></div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-700 via-blue-600 to-purple-700 text-white relative overflow-hidden">
        ...
        <div className="absolute -top-20 -right-20 w-80 h-80 bg-purple-500 rounded-full opacity-20 blur-xl"></div>
        <div className="absolute -bottom-40 -left-20 w-96 h-96 bg-blue-400 rounded-full opacity-20 blur-xl"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <Badge variant="outline" className="mb-6 px-5 py-1.5 text-white border-white/30 bg-white/10 backdrop-blur-[2px] shadow-lg">Get Started Today</Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Button size="lg" className="bg-white text-blue-700 px-8 py-6 text-lg" asChild>
                <Link href="/auth/signup?type=professional">
                  Sign Up as a Professional
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="border-white bg-white/10 backdrop-blur-[2px] text-white hover:bg-white/20 font-medium border-2 px-8 py-6 text-lg hover:shadow-lg transition-all duration-300" asChild>
